...
\subsection{Clave y nombre de la Unidad de Aprendizaje:} \fbox{701 Tesis 2}
...
Se apoya al participante en la {\bf finalizaci\'{o}n} de su trabajo de
{\em tesis de maestr\'{\i}a}.
...
\input{c12.tex} & Avances en el documento de tesis, bit\'{a}cora semanal \\ \hline
...
Estructuraci\'{o}n y estilo de un trabajo formal de tesis de maestr\'{\i}a.
...
citada. No habr\'{a} examen. Son 19 avances semanales m\'{a}s la
entrega del portafolio, otorgando por m\'{a}ximo 5 puntos por semana
con la siguiente escala: \input{escala05.tex}
...
semestre, se espera que un alumno concluya varios cap\'{\i}tulos ---
se visitan de forma sistem\'{a}tica todos los elementos de un trabajo
de tesis de maestr\'{\i}a para analizar el avance actual y
calendarizar de manera estructurada el trabajo pendiente para
su pronta finalizaci\'{o}n.
