...
\item{Coinciden Clave y nombre de la Unidad de Aprendizaje del
  ...
  Programa Sint\'{e}tico  \hfill \CheckBox[name=box1,checkboxsymbol=\ding{56}]{S\'{i}}
  \quad
  \CheckBox[name=box2,checkboxsymbol=\ding{56}]{No}}
...
\item{Coincide la Frecuencia semanal del Programa Anal\'{i}tico con la
  ...
  \CheckBox[name=box3,checkboxsymbol=\ding{56}]{S\'{i}}
  \quad
  \CheckBox[name=box4,checkboxsymbol=\ding{56}]{No}
\end{flushright}
}

\item{Coinciden las Horas de trabajo extra aula por semana del
  Programa Anal\'{i}tico con la informaci\'{o}n de su correspondiente
  Programa Sint\'{e}tico   \hfill \CheckBox[name=box5,checkboxsymbol=\ding{56}]{S\'{i}}
  \quad
  \CheckBox[name=box6,checkboxsymbol=\ding{56}]{No}}

\item{Coincide la Modalidad del Programa Anal\'{i}tico con la
  informaci\'{o}n de su correspondiente Programa Sint\'{e}tico
  \begin{flushright}
    \CheckBox[name=box7,checkboxsymbol=\ding{56}]{S\'{i}}
    \quad \CheckBox[name=box8,checkboxsymbol=\ding{56}]{No}\end{flushright}}
...
\item{Coincide el Periodo Acad\'{e}mico del Programa Anal\'{i}tico con
  ...
  \begin{flushright}
  \CheckBox[name=box9,checkboxsymbol=\ding{56}]{S\'{i}}
  \quad
  \CheckBox[name=box10,checkboxsymbol=\ding{56}]{No}
\end{flushright}
}

\item{Coinciden las LGAC del Programa Anal\'{i}tico con la
  informaci\'{o}n de su correspondiente Programa Sint\'{e}tico
  \begin{flushright}\CheckBox[name=box11,checkboxsymbol=\ding{56}]{S\'{i}}
  \quad%
  \CheckBox[name=box12,checkboxsymbol=\ding{56}]{No}
  \end{flushright}}
...
\item{Coincide en la Ubicaci\'{o}n semestral el Programa Anal\'{i}tico
  ...
  \begin{flushright}
  \CheckBox[name=box13,checkboxsymbol=\ding{56}]{S\'{i}}
  \quad
  \CheckBox[name=box14,checkboxsymbol=\ding{56}]{No}
\end{flushright}
}
...
\item{Coincide el \'{A}rea Curricular del Programa Anal\'{i}tico con
  la informaci\'{o}n de su correspondiente Programa Sint\'{e}tico
  \begin{flushright}
  \CheckBox[name=box15,checkboxsymbol=\ding{56}]{S\'{i}}
  \quad
  \CheckBox[name=box16,checkboxsymbol=\ding{56}]{No}
\end{flushright}
}
...
\item{Coincide el n\'{u}mero de Cr\'{e}ditos del Programa
  ...
  \CheckBox[name=box17,checkboxsymbol=\ding{56}]{S\'{i}}
  \quad
  \CheckBox[name=box18,checkboxsymbol=\ding{56}]{No}
\end{flushright}
}
...
\item{Coincide en los requisitos establecidos para cursar la Unidad de
  ...
  \begin{flushright}\CheckBox[name=box19,checkboxsymbol=\ding{56}]{S\'{i}}%
    \quad%
    \CheckBox[name=box20,checkboxsymbol=\ding{56}]{No}
    \end{flushright}}
...
\item{La fecha de elaboraci\'{o}n del Programa Anal\'{i}tico es
  ...
  Sint\'{e}tico \begin{flushright}
  \CheckBox[name=box21,checkboxsymbol=\ding{56}]{S\'{i}}
  \quad
  \CheckBox[name=box22,checkboxsymbol=\ding{56}]{No}
\end{flushright}
}
...
\item{La fecha de la \'{u}ltima actualizaci\'{o}n del Programa
  ...
  menos de tres a\~{n}os, por lo que se puede considerar vigente
    \hfill \CheckBox[name=box23,checkboxsymbol=\ding{56}]{S\'{i}}%
  \quad%
  \CheckBox[name=box24,checkboxsymbol=\ding{56}]{No}}
...
\item{Entre los Responsables del dise\~{n}o de la Unidad de
  ...
  \CheckBox[name=box25,checkboxsymbol=\ding{56}]{S\'{i}}
  \quad
  \CheckBox[name=box26,checkboxsymbol=\ding{56}]{No}
\end{flushright}
}

\item{El perfil de egreso vinculado a la Unidad de Aprendizaje
  estipulado en el Programa Anal\'{i}tico es congruente con la
  informaci\'{o}n de su correspondiente Programa Sint\'{e}tico   \hfill \CheckBox[name=box27,checkboxsymbol=\ding{56}]{S\'{i}}%
  \quad%
  \CheckBox[name=box28,checkboxsymbol=\ding{56}]{No}}
...
lo estipulado por el Programa Sint\'{e}tico.   \hfill \CheckBox[name=box29,checkboxsymbol=\ding{56}]{S\'{i}}%
  \quad%
  \CheckBox[name=box30,checkboxsymbol=\ding{56}]{No}
...
Sint\'{e}tico.   \hfill \CheckBox[name=box31,checkboxsymbol=\ding{56}]{S\'{i}}%
  \quad%
  \CheckBox[name=box32,checkboxsymbol=\ding{56}]{No}
...
Sint\'{e}tico   \hfill \CheckBox[name=box33,checkboxsymbol=\ding{56}]{S\'{i}}%
  \quad%
  \CheckBox[name=box34,checkboxsymbol=\ding{56}]{No}}
...
Programa Sint\'{e}tico   \hfill \CheckBox[name=box35,checkboxsymbol=\ding{56}]{S\'{i}}%
  \quad%
  \CheckBox[name=box36,checkboxsymbol=\ding{56}]{No}}
\end{enumerate}
...
de las etapas de la unidad de aprendizaje.   \hfill \CheckBox[name=box37,checkboxsymbol=\ding{56}]{S\'{i}}%
  \quad%
  \CheckBox[name=box38,checkboxsymbol=\ding{56}]{No}
...
adecuados.   \hfill \CheckBox[name=box39,checkboxsymbol=\ding{56}]{S\'{i}}%
  \quad%
  \CheckBox[name=box40,checkboxsymbol=\ding{56}]{No}
...
ejecuci\'{o}n pr\'{a}ctica, investigaci\'{o}n y s\'{i}ntesis, ex\'{a}menes, y el producto integrador.   \hfill \CheckBox[name=box41,checkboxsymbol=\ding{56}]{S\'{i}}%
  \quad%
  \CheckBox[name=box42,checkboxsymbol=\ding{56}]{No}
...
recursos que son claros y asequibles.   \hfill \CheckBox[name=box43,checkboxsymbol=\ding{56}]{S\'{i}}%
  \quad%
  \CheckBox[name=box44,checkboxsymbol=\ding{56}]{No}
...
UANL. \begin{flushright}
  \CheckBox[name=box45,checkboxsymbol=\ding{56}]{S\'{i}}
  \quad
  \CheckBox[name=box46,checkboxsymbol=\ding{56}]{No}
\end{flushright}
