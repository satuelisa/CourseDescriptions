...
\usepackage{multicol}
\usepackage{enumitem}
\usepackage[top=1cm,left=20mm,right=25mm,bottom=2cm]{geometry}
...
{\em Favor de llenar directamente en computadora con Adobe Acrobat Reader.}
...
\begin{Form}
  ...
  \TextField[name=year,multiline=false,bordercolor=black,align=0,width=1cm,height=1.2em]{Año}

  {Programa:}
  \ChoiceMenu[radio,radiosymbol=\ding{52},print,name=pe]{}{Maestría}
  \ChoiceMenu[radio,radiosymbol=\ding{52},print,name=pe]{}{Doctorado}

 \TextField[name=nom,multiline=false,bordercolor=black,align=0,width=4cm,height=1.2em]{Nombre(s)}
 \TextField[name=ape,multiline=false,bordercolor=black,align=0,width=6cm,height=1.2em]{Apellido(s)}

 \TextField[name=nac,multiline=false,bordercolor=black,align=0,width=5cm,height=1.2em]{Nacionalidad(es)}

 \TextField[name=fn,multiline=false,bordercolor=black,align=0,width=4cm,height=1.2em]{Fecha de nacimiento}
 ...
 \TextField[name=rfc,multiline=false,bordercolor=black,align=0,width=4cm,height=1.2em]{RFC}
  ...
  {Domicilio actual} \\ \\
  \TextField[name=act,multiline=true,bordercolor=black,align=0,width=10cm,height=8em]{}

  {Domicilio permanente (si diferente del actual)} \\  \\
  \TextField[name=perm,multiline=true,bordercolor=black,align=0,width=10cm,height=10em]{}
  ...
  \TextField[name=email,multiline=false,bordercolor=black,align=0,width=4cm,height=1.2em]{Correo
    electrónico}
...
\begin{flushright}
  {\em Dejar en blanco aquellos campos que no aplican.}
\end{flushright}
...
{\bf Última fecha de presentación exámenes de admisión a posgrado de la UANL:}
...
indicar escuela, programa, periodo (desde-hasta mes/año), grado
obtenido y promedio \\ \\
...
\CheckBox{Copias de kárdex de estudios superiores} \\
\CheckBox{Tesis de grados anteriores} \\
\CheckBox{Cartas de recomendación (doctorado)} \\
\CheckBox{Anteproyecto (doctorado)}
\end{flushright}
