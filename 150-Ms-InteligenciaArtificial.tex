...
\\ % evidencia
\node[evid](tareas) {Tareas};
&
&
\node[evid](proyecto) {Proyecto};
...
&
\node[comp](e2ii) {E2 Nivel II B\'{a}sico};
& &
\node[comp](e2iii) {E2 Nivel III Aut\'{o}nomo};
\\};
  \draw [line] (tareas) -- (e2ii);
  \draw [line] (proyecto) -- (e2ii);
  \draw [line] (tareas) -- (e2iii);
  \draw [line] (proyecto) -- (e2iii);
  \draw [line] (tareas) -- (c2);
  \draw [line] (tareas) -- (c3);
  \draw [line] (tareas) -- (c5);
  \draw [line] (proyecto) -- (c5);
  \draw [line] (ide) -- (lit);
  \draw [line] (ide) -- (des);
  \draw [line] (ide) -- (her);
  \draw [line] (lit) -- (des);
  ...
  \draw [line] (apl) -- (doc);
  \draw [line] (doc) -- (exp);
  \draw [line] (exp) -- (proyecto);
  \draw [line] (doc) -- (proyecto);
  \draw [line] (doc) -- (tareas);
  \draw [line] (apl) -- (tareas);
\input{enddiagram}
