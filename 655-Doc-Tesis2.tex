...
\subsection{Clave y nombre de la Unidad de Aprendizaje:} \fbox{655 Tesis 2}
...
&
\node[elem] (des) {Desarrollar de manera iniciar la soluci\'{o}n propuesta};
&
...
&
\node[elem] (imp) {Continuar la implementaci\'{o}n del m\'{e}todo};
\\
&
\node[elem] (ana) {Dise\~{n}ar de forma inicial los experimentos para
...
\item Redacci\'{o}n de un  primer borrador de la introducci\'{o}n
\item Planteamiento de la hip\'{o}tesis y de los objetivos
\item Principios para la redacci\'{o}n de los antecedentes
\item Principios para la redacci\'{o}n de la clasificaci\'{o}n de trabajos relacionados
\item Principios para la redacci\'{o}n del an\'{a}lisis comparativo de trabajos relacionados
\item Principios para la redacci\'{o}n de la identificaci\'{o}n del \'{a}rea de oportunidad
...
reportando lo discutido y avanzado en cada semana. Siendo segundo
...
unidad de aprendizaje (Tesis 2, en este caso), semestre en que se
