...
\item[20\%]{Proyecto integrador: dise\~{n}o e implementaci\'{o}n de una metaheur\'{i}stica}  
\item[15\%]{Examen ordinario}
\end{description}  
...
\begin{description}
\item[10\%]{Ejercicios de an\'{a}lisis de costo-beneficio de tipos de memoria}
...
\item[20\%]{Proyecto integrador: dise\~{n}o e implementaci\'{o}n de una base
  de datos para un escenario pr\'{a}ctico}
\item[15\%]{Examen ordinario}
\end{description}  
