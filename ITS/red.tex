...
Segundo semestre. Tres cr\'{e}ditos.

\begin{itemize}
\item{Representaci\'{o}n en bases}
\item{L\'{o}gica booleana}
\item{Conjuntos}
\item{Permutaciones}  
\item{Grafos simples no dirigidos}
\item{Caminos y distancias}
\item{\'{A}rboles de expansi\'{o}n}
\item{Aut\'{o}matas}
...
Tercer semestre. Tres cr\'{e}ditos. Incluye laboratorio. Requiere {\em Matem\'{a}ticas discretas}.
...
Tres cr\'{e}ditos. Optativa de segundo semestre.

\begin{itemize}
\item{Variables}  
\item{Tipos, operadores y expresiones}
\item{Condiciones}
\item{Ciclos}
\item{Entrada y salida en consola}
\item{Flujo de control}
\item{Subrutinas y estructura de programa}
\item{Punteros}
\item{Arreglos}
\item{Estructuras}
...
Cuatro cr\'{e}ditos. Optativa de segundo semestre.
...
\item{Recorrido y b\'{u}squeda}
\item{Complejidad asint\'{o}tica}
\item{T\'{e}cnica dividir-conquistar}
\end{itemize}
...
optativa de segundo semestre (C o Python).
...
\item{Pruebas unitarisa (pr\'{a}ctica en laboratorio)}
...
Cuarto semestre. Tres cr\'{e}ditos. Requiere \hyperlink{md}{\em Matem\'{a}ticas discretas}.
...
\item{Teoremas asint\'{o}ticas}
\item{Modelos de urnas}
