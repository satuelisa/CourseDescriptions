...
\input{startdiagram}
& 
\node[elem] (ide) {Actualizar el calendario de actividades para la tesis};
\\
\node[elem] (lit) {Actualizar revisar literatura cient\'{\i}fica relacionada relevante};
&
\node[elem] (des) {Continuar la soluci\'{o}n propuesta};
&
\node[elem] (her) {Actualizar herramientas computacionales
  existentes para implementar el m\'{e}todo};
\\
\node[elem] (for) {Actualizar hip\'{o}tesis para la validaci\'{o}n del
  modelo propuesto};
& &
\node[elem] (sel) {Seleccionar las herramientas seg\'{u}n las caracter\'{\i}sticas del m\'{e}todo};
\\
\node[elem] (dis) {Iniciar el dise\~{n}o del m\'{e}todo};
&
\node[elem] (imp) {Iniciar la implementaci\'{o}n del m\'{e}todo};
\\
&
...
\item Un primer borrador de la clasificaci\'{o}n de trabajos relacionados
\item Un primer borrador del an\'{a}lisis comparativo de trabajos relacionados
\item Un primer borrador de la identificaci\'{o}n del \'{a}rea de oportunidad
\item Principios avanzados para la redacci\'{o}n de la metodolog\'{\i}a
\item Principios avanzados para la redacci\'{o}n del dise\~{n}o de la soluci\'{o}n propuesta
\item Principios avanzados la redacci\'{o}n de la implementaci\'{o}n de la soluci\'{o}n propuesta
...
unidad de aprendizaje (Tesis 4, en este caso), semestre en que se
