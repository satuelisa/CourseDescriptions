...
\subsection{Nombre:} \fbox{Tesis 6}
...
&
\node[elem] (des) {Finalizar la soluci\'{o}n propuesta};
\\
...
\\
\node[elem] (dis) {Finalizar el dise\~{n}o del m\'{e}todo};
&
\node[elem] (imp) {Finalizar la implementaci\'{o}n del m\'{e}todo};
\\
&
\node[elem] (ana) {Realizar experimentos iniciales};
\\ 
...
\item Primer borrador de la redacci\'{o}n del dise\~{n}o de la soluci\'{o}n propuesta
\item Primer borrador de la redacci\'{o}n de la implementaci\'{o}n de la soluci\'{o}n propuesta
\item Principios avanzados para la redacci\'{o}n del dise\~{n}o experimental
\item Principios avanzados para la redacci\'{o}n de reportaje de resultados experimentales
\item Principios avanzados para la redacci\'{o}n del an\'{a}lisis de experimentos
\item Principios avanzados para la redacci\'{o}n de la discusi\'{o}n de los experimentos
...
cap\'{\i}tulo en particular, aunque varios ya deber\'{\i}an estar
cerca de su forma final --- se visitan de forma sistem\'{a}tica
...
unidad de aprendizaje (Tesis 6, en este caso), semestre en que se
