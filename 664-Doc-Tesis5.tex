...
\subsection{Ubicaci\'{o}n semestral:} \fbox{5}
\subsection{\'{A}rea curricular:} \underline{\pi}
\subsection{Cr\'{e}ditos:} \fbox{6}
\subsection{Requisito:} \fbox{Tesis 4}
...
\item UT3: Un primer borrador de la redacci\'{o}n de la metodolog\'{\i}a
...
Siendo {\bf quinto} semestre, no se espera que un alumno concluya a
