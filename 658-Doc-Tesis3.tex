...
\subsection{Clave y nombre de la Unidad de Aprendizaje:} \fbox{658 Tesis 3}
...
\input{comp_gen.tex}
\input{c7.tex} & Avances en el documento de tesis, bit\'{a}cora semanal \\ \hline
\input{c11.tex} & Avances en el documento de tesis, bit\'{a}cora semanal \\ \hline
\input{c12.tex} & Avances en el documento de tesis, bit\'{a}cora
semanal \\ \hline
\input{c13.tex} & Avances en el documento de tesis, bit\'{a}cora semanal \\ \hline
\end{tabular}
...
\input{startdiagram}
& 
\node[elem] (ide) {Actualizar el calendario de actividades};
\\
\node[elem] (lit) {Revisar literatura cient\'{\i}fica relacionada relevante};
&
\node[elem] (des) {Avanzar la soluci\'{o}n propuesta};
&
\node[elem] (her) {Actualizar herramientas computacionales
  existentes para implementar el m\'{e}todo};
\\
\node[elem] (for) {Formular hip\'{o}tesis para la validaci\'{o}n del
  modelo propuesto};
& &
\node[elem] (sel) {Ajustar las herramientas seg\'{u}n las caracter\'{\i}sticas del m\'{e}todo};
\\
\node[elem] (dis) {Continuar el dise\~{n}o del m\'{e}todo};
&
\node[elem] (imp) {Avanzar la implementaci\'{o}n del m\'{e}todo};
\\
&
\node[elem] (ana) {Dise\~{n}ar algunos experimentos para
  contrastar sus resultados con las hip\'{o}tesis};
\\ 
& & \node[elem] (doc) {Documentar los avances conforme al estilo de
...
\item Redacci\'{o}n de un primer borrador de los antecedentes
\item Principios avanzados para la redacci\'{o}n de la clasificaci\'{o}n de trabajos relacionados
\item Principios avanzados para la redacci\'{o}n del an\'{a}lisis comparativo de trabajos relacionados
\item Principios avanzados para la redacci\'{o}n de la identificaci\'{o}n del \'{a}rea de oportunidad
\item Principios para la redacci\'{o}n de la metodolog\'{\i}a
\item Principios para la redacci\'{o}n del dise\~{n}o de la soluci\'{o}n propuesta
\item Principios para la redacci\'{o}n de la implementaci\'{o}n de la soluci\'{o}n propuesta
\item Principios para la redacci\'{o}n del dise\~{n}o experimental
\item Principios para la redacci\'{o}n de reportaje de resultados experimentales
\item Principios para la redacci\'{o}n del an\'{a}lisis de experimentos
\item Principios para la redacci\'{o}n de la discusi\'{o}n de los experimentos
\item Principios para la redacci\'{o}n de las conclusiones
\item Principios para la redacci\'{o}n de trabajo a futuro
\item Principios para la redacci\'{o}n del formato de la bibliograf\'{\i}a
...
Estructuraci\'{o}n y estilo de un traajo formal de tesis de doctorado.
...
reportando lo discutido y avanzado en cada semana. Siendo tercer
...
unidad de aprendizaje (Tesis 3, en este caso), semestre en que se
