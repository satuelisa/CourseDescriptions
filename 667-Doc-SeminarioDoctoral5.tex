...
\subsection{Nombre:} \fbox{Seminario doctoral 5}
...
continuaci\'{o}n de {\em Seminario doctoral 4} y se busca profundizar en
...
&  
\node[elem] (doc) {Formar una primera versión de una exposici\'{o}n de su propia
  investigaci\'{o}n};
\\
};
\draw [line] (ide) -- (lit);
