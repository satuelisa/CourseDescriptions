...
\subsection{Clave y nombre de la Unidad de Aprendizaje:} \fbox{652 Tesis 1}
...
inicial de su trabajo de {\em tesis de doctorado}.
...
\input{startdiagram}
& 
\node[elem] (ide) {Plantear conjuntamente con el asesor asignado
  un tema de tesis};
\\
...
reportando lo discutido y avanzado en cada semana. Siendo primer
semestre, no se espera que un alumno concluya a ning\'{u}n
cap\'{\i}tulo --- se visitan de forma sistem\'{a}tica
