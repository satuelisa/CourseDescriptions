...
\subsection{Nombre:} \fbox{Seminario 2}
...
\subsection{Competencias generales a que se vincula la Unidad de
  ...
  \input{c11.tex} & Asistencia y organizaci\'{o}n del seminario \\ \hline
  \input{c12.tex} & Asistencia y organizaci\'{o}n del seminario \\ \hline
  \input{c13.tex} & Asistencia y organizaci\'{o}n del seminario \\ \hline
  \end{tabular}
...
\subsection{Competencias espec\'{\i}ficas y nivel de dominio a que se vincula la unidad de aprendizaje:}
  ...
  \input{e2.tex}
  & & & & & \input{encuentra.tex} & Participaci\'{o}n y presentaci\'{o}n en los seminarios y en su organizaci\'{o}n.
  &  \input{establece.tex} & Participaci\'{o}n y presentaci\'{o}n en los seminarios y en su organizaci\'{o}n.
...
&  
\node[elem] (doc) {\bf Exponer su propia
  investigaci\'{o}n};
\\
};
\draw [line] (ide) -- (lit);
