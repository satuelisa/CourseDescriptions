...
M\'{e}todos diversos de preprocesamiento y visualizaci\'{o}n de datos.
...
\subsubsection{Unidad tem\'{a}tica 2: M\'{e}todos estad\'{i}sticos en la ciencia de datos}
...
c\'{o}digo de la implementaci\'{o}n de un m\'{e}todo estad\'{\i}stico de
ciencia de datos.

&

Calidad de la redacci\'{o}n cient\'{\i}fica del reporte; precisi\'{o}n
del m\'{e}todo; eficiencia de la implementaci\'{o}n del algoritmo;
...
M\'{e}todos estad\'{\i}sticos diversos de ciencia de datos.
...
\subsubsection{Unidad tem\'{a}tica 3: Objectivos y t\'{e}cnicas para aplicaciones de la ciencia de datos}
...
Seis (6) tareas semanales, siendo cada una un reporte escrito y
c\'{o}digo de la aplicaci\'{o}n de un m\'{e}todo de ciencia de datos.

&

Calidad de la redacci\'{o}n cient\'{\i}fica del reporte; precisi\'{o}n
y eficiencia de la t\'{e}cnica aplicada; cobertura de la
experimentaci\'{o}n.
...
Aplicaciones diversas de ciencia de datos.
