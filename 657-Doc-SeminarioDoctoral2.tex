...
\subsection{Clave y nombre de la Unidad de Aprendizaje:} \fbox{{\siid} Seminario doctoral 2}
...
\subsection{Ubicaci\'{o}n semestral:} \fbox{2}
\subsection{\'{A}rea curricular:} \underline{\fr}
\subsection{Cr\'{e}ditos:} \fbox{4}
\subsection{Requisito:} \fbox{Seminario doctoral 1}
...
\input{cont-sem-sinpre-doc2.tex}
