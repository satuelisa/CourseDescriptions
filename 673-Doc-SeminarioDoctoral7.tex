...
\subsection{Clave y nombre de la Unidad de Aprendizaje:} \fbox{{\sviid} Seminario doctoral 7}
...
\subsection{Ubicaci\'{o}n semestral:} \fbox{7}
\subsection{\'{A}rea curricular:} \underline{\inv}
\subsection{Cr\'{e}ditos:} \fbox{4}
\subsection{Requisito:} \fbox{Seminario doctoral 6}
