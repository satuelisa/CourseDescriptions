...
\matrix[row sep=7mm, column sep=1mm] at (0, 0) {
  ...
  \matrix[row sep=7mm, column sep=1mm] at (9, 0){
    ...
    \node[elem](e1) {Aplicar m\'{e}todos de b\'{u}squeda}; \\
    \node[elem](e2) {Aplicar planeaci\'{o}n}; \\
    \node[elem](e3) {Aplicar algoritmos evolutivos}; \\
    \node[elem](e4) {Aplicar aprendizaje m\'{a}quina}; \\
  };
