...
\subsection{Clave y nombre de la Unidad de Aprendizaje:} \fbox{674 Tesis 8}
...
\\
&
\node[elem] (ana) {Realizar experimentos adicionales, si hace falta};
\\ 
& & \node[elem] (doc) {Actualizar la discus\'{\i}on de los resultados conforme al estilo de
  redacci\'{o}n cient\'{\i}fica};
\\ 
\node[elem] (apl) {Aplicar visualizaci\'{o}n cient\'{\i}fica};
& &
